...
let text1 = d3.select(".text1").text(); // refernces content with class="text1" in the html
console.log("text1 says: ", text1);

let text2 = d3.select("#text2").text(); // refernces content with class="text2" in the html
