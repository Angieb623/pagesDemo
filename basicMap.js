// create a map object using the L reference to reference leaflet
let myMap = L.map("map", {
...
let marker = L.marker([35.3074, -80.7352], {
    title: "UNC Charlotte"
}).addTo(myMap);

// we can also make our marker clickable by binding a popup
marker.bindPopup("Hello from UNCC!");
...
// make more popups by looping through the above array
